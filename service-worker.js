import { config as unoConfig } from "/package_00ad99b6144192e21a1b52dca662aa8178c5eb6c/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('4521e54c-3f64-4fe8-bb4e-f1d3c5fbaa1a').then(async function (cache) {
            ...
            caches.keys().then(function (cacheNames) {
                return Promise.all(
                    cacheNames.filter(function (cacheName) {
                        return cacheName !== '4521e54c-3f64-4fe8-bb4e-f1d3c5fbaa1a';
